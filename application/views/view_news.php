...
<div class="blog-one-area pt_0 pb_0">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">               
                ...
                foreach($news_fetched as $row) {
                    ...
                    <div class="blog-one-item">
                        <div class="blog-one-photo">
                            <a href="<?php echo base_url(); ?>news/view/<?php echo $row->news_id; ?>"><img src="<?php echo base_url(); ?>public/uploads/<?php echo $row->photo; ?>" height="60px" alt="Blog Photo"></a>
                        </div>
